...
class sportGermany extends StatefulWidget {
  String idUser;
  sportGermany({this.idUser});

  _sportGermanyState createState() => _sportGermanyState();
}

class _sportGermanyState extends State<sportGermany> {
  ///
