...
class artGermany extends StatefulWidget {
  String idUser;
  artGermany({this.idUser});

  _artGermanyState createState() => _artGermanyState();
}

class _artGermanyState extends State<artGermany> {
  ///
