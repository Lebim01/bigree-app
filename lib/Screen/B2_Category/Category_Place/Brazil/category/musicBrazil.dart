...
class musicBrazil extends StatefulWidget {
  String idUser;
  musicBrazil({this.idUser});

  _musicBrazilState createState() => _musicBrazilState();
}

class _musicBrazilState extends State<musicBrazil> {
  ///
