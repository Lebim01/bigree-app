...
class sportBrazil extends StatefulWidget {
  String idUser;
  sportBrazil({this.idUser});

  _sportBrazilState createState() => _sportBrazilState();
}

class _sportBrazilState extends State<sportBrazil> {
  ///
