...
class artUnitedStates extends StatefulWidget {
  String idUser;
  artUnitedStates({this.idUser});

  _artUnitedStatesState createState() => _artUnitedStatesState();
}

class _artUnitedStatesState extends State<artUnitedStates> {
  ///
