...
class musicUnitedStates extends StatefulWidget {
  String idUser;
  musicUnitedStates({this.idUser});

  _musicUnitedStatesState createState() => _musicUnitedStatesState();
}

class _musicUnitedStatesState extends State<musicUnitedStates> {
  ///
