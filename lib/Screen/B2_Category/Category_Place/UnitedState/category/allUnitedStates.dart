...
class allUnitedStates extends StatefulWidget {
  String idUser;
  allUnitedStates({this.idUser});

  _allUnitedStatesState createState() => _allUnitedStatesState();
}

class _allUnitedStatesState extends State<allUnitedStates> {
  ///
