...
class allNetherland extends StatefulWidget {
  String idUser;
  allNetherland({this.idUser});

  _allNetherlandState createState() => _allNetherlandState();
}

class _allNetherlandState extends State<allNetherland> {
  ///
