...
class artNetherland extends StatefulWidget {
  String idUser;
  artNetherland({this.idUser});

  _artNetherlandState createState() => _artNetherlandState();
}

class _artNetherlandState extends State<artNetherland> {
  ///
