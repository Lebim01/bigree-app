...
class musicNetherland extends StatefulWidget {
  String idUser;
  musicNetherland({this.idUser});

  _musicNetherlandState createState() => _musicNetherlandState();
}

class _musicNetherlandState extends State<musicNetherland> {
  ///
