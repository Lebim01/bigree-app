...
import 'package:event_country/Screen/B1_Home/Detail_Event.dart';
import 'package:event_country/Screen/B2_Category/Page_Transformer_Card/page_transformer.dart';
import 'package:flutter/material.dart';
import 'package:shimmer/shimmer.dart';

class sportNetherland extends StatefulWidget {
  String idUser;
  sportNetherland({this.idUser});

  _sportNetherlandState createState() => _sportNetherlandState();
}

class _sportNetherlandState extends State<sportNetherland> {
  ///
                ...
                Padding(
                    ...
                    child: StreamBuilder(
                      stream: Firestore.instance
                          .collection("event")
                          .where('country', isEqualTo: 'netherland')
