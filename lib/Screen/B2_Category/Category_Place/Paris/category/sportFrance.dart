...
class sportFrance extends StatefulWidget {
  String idUser;
  sportFrance({this.idUser});

  _sportFranceState createState() => _sportFranceState();
}

class _sportFranceState extends State<sportFrance> {
  ///
