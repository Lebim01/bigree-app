...
class musicFrance extends StatefulWidget {
  String idUser;
  musicFrance({this.idUser});

  _musicFranceState createState() => _musicFranceState();
}

class _musicFranceState extends State<musicFrance> {
  ///
